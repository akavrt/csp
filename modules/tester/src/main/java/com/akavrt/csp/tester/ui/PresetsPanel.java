...
public class PresetsPanel extends JPanel {
    ...
    public PresetsPanel() {
        ...
        add(geneticPanel, new GBC(0, 1).setFill(GBC.HORIZONTAL).setWeight(100, 0));
        add(objectivePanel, new GBC(0, 2).setFill(GBC.HORIZONTAL).setWeight(100, 0));
        add(new JPanel(), new GBC(0, 3).setFill(GBC.BOTH).setWeight(100, 100));
